...
public class VegListController 
{
    ...
    void onShow(ActionEvent event) throws ClassNotFoundException 
	{
		...
		try
		{
			...
			String sql = "select S.first_name,S.last_name,nvl(F.Allergic_To,'None')  from student S, food_Pref F where S.RegNo = F.RegNo and F.FoodPref = 'Vegetarian'";
